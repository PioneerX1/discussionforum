...
public class FirebaseCategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bindCategory(Category category) {
        ...
        TextView categoryNameTextView = (TextView) mView.findViewById(R.id.categoryNameTextView);
        TextView categoryDescriptionTextView = (TextView) mView.findViewById(R.id.categoryDescriptionTextView);
